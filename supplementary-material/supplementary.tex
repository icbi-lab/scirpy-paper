...
\begin{figure}[!ht]
  ...
  \caption{
    ...
    assuming a powerlaw-distribution of clonal frequencies \cite{Greiff2015, Weber2020}.
    To obtain clonal frequencies representative for single-cell TCR sequencing data, we fitted a powerlaw distribution
    ...
    The source-code to reproduce the runtime analysis is available from Scirpy GitHub repository\protect\footnotemark
    }
\end{figure}
