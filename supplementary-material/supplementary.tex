...
\begin{figure}[!ht]
  ...
  \caption{\textbf{Runtime analysis on simulated datasets.} We simulated 500,000 TCR-\textalpha\ and -\textbeta\ sequences using the \texttt{immuneSIM} package \cite{Weber2020}. \textbf{(a)} Performance of \texttt{tcr\_dist}. \textbf{(b)} Performance of \texttt{tcr\_neighbors}}
\end{figure}
