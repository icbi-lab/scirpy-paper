...
\begin{tabular}{p{2cm}p{4cm}p{1.2cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}p{0.6cm}}
  ...
  \rotatebox[origin=l]{45}{\begin{tabular}[c]{@{}l@{}}Support\\[-1.6em]\\for smartSeq2\end{tabular}} &
...
TRUST4 &
  ...
  Perl &
  TCR &
  \cellcolor[rgb]{0.7,0.7,0.1}\sim\footnote[1]{Requires extra settings.} &
  \cellcolor[rgb]{0.7,0.7,0.1}\sim\footnotemark[1] &
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
...
TraCeR &
  ...
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.1,0.7,0.1}\checkmark &
  \cellcolor[rgb]{0.7,0.7,0.1}\sim\footnote[2]{Requires special skills and extra coding.} &
...
\raggedright VDJ Puzzle &
  ...
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.7,0.1,0.1}\xmark &
  \cellcolor[rgb]{0.7,0.7,0.1}\sim\footnotemark[2] &
